...
if __name__ == "__main__":
    ...
    OUTPUT_CSV = "../output_similarity.csv"
    ...
    smart_add_comparison_group(
        MODEL_ID,
        "../AISumerCamp_audio_generation_fight/aigc_speech_generation_tasks/", #对比文件目录a
        "../new_data/resample/2_output/", #对比文件目录b
        "reference_",#a目录下文件前缀
        "synthesized_speech_",#b目录下文件前缀
        OUTPUT_CSV,#输出的csv位置
        "2_output",#记录栏名称
    ...
    smart_add_comparison_group(
        MODEL_ID,
        "../AISumerCamp_audio_generation_fight/aigc_speech_generation_tasks/", #对比文件目录a
        "../new_data/resample/3_output/", #对比文件目录b
        "reference_",#a目录下文件前缀
        "synthesized_speech_",#b目录下文件前缀
        OUTPUT_CSV,#输出的csv位置
        "3_output",#记录栏名称
    ...
    smart_add_comparison_group(
        MODEL_ID,
        "../AISumerCamp_audio_generation_fight/aigc_speech_generation_tasks/", #对比文件目录a
        "../new_data/resample/4_output/", #对比文件目录b
        "reference_",#a目录下文件前缀
        "synthesized_speech_",#b目录下文件前缀
        OUTPUT_CSV,#输出的csv位置
        "4_output",#记录栏名称
    ...
    smart_add_comparison_group(
        MODEL_ID,
        "../AISumerCamp_audio_generation_fight/aigc_speech_generation_tasks/", #对比文件目录a
        "../new_data/resample/5_output/", #对比文件目录b
        "reference_",#a目录下文件前缀
        "synthesized_speech_",#b目录下文件前缀
        OUTPUT_CSV,#输出的csv位置
        "5_output",#记录栏名称
    ...
    smart_add_comparison_group(
        MODEL_ID,
        "../AISumerCamp_audio_generation_fight/aigc_speech_generation_tasks/", #对比文件目录a
        "../new_data/resample/6_output/", #对比文件目录b
        "reference_",#a目录下文件前缀
        "synthesized_speech_",#b目录下文件前缀
        OUTPUT_CSV,#输出的csv位置
        "6_output",#记录栏名称
